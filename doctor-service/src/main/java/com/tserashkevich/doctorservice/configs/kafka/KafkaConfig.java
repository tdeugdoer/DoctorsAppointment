package com.tserashkevich.doctorservice.configs.kafka;
...
public class KafkaConfig {
    ...
    ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, environment.getProperty("spring.kafka.consumer.spring.deserializer.value.delegate.class"));
