...
public class LogList {
    ...
    public final String CREATE_DOCTOR = "Doctor created with ID: {}";
    public final String EDIT_DOCTOR = "Doctor edited with ID: {}";
    public final String DELETE_DOCTOR = "Doctor deleted with ID: {}";
    public final String FIND_ALL_DOCTORS = "Found all doctors";
    public final String FIND_DOCTOR = "Found doctors with ID: {}";
