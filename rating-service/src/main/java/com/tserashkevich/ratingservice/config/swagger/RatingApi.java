...
public interface RatingApi {
    ...
    RatingResponse updateRating(@Parameter(description = "Id of a updating rating") @PathVariable UUID id,
                                @Parameter(description = "Update rating request") @Valid @RequestBody UpdateRatingRequest updateRatingRequest);
    ...
    @ApiResponse(responseCode = "400", description = "Wrong request parameter value",
            content = @Content(schema = @Schema(implementation = ExceptionResponse.class)))
    PageResponse<RatingResponse> findAllRatings(@Parameter(description = "Page number") @RequestParam(defaultValue = "0") @Min(0) int page,
    ...
    @Operation(summary = "Get avg rating by doctor ID", description = "Returns an average rating by doctor ID.")
    ...
    @ApiResponse(responseCode = "404", description = "Rating not found",
            content = @Content(schema = @Schema(implementation = ExceptionResponse.class)))
    Double findDoctorAvgRating(@Parameter(description = "Doctor ID") @PathVariable UUID doctorId);
    ...
    @ApiResponse(responseCode = "404", description = "Rating not found",
            content = @Content(schema = @Schema(implementation = ExceptionResponse.class)))
    List<Feedback> findDoctorFeedbacks(@Parameter(description = "Doctor ID") @PathVariable UUID doctorId);
}
